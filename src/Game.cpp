            ...
            if (_user1->getSide() == Side::eDark) {
                        ...
                        if (hl == 1) {
                            ...
                            while (true) {
                                ...
                                if (harmless == "dwarf") {
                                    ...
                                    rn = _user2->harmless(ArmyType::eMankingArmy, roundNo).first;
                                    type = _user2->harmless(ArmyType::eMankingArmy, roundNo).second;
                                } else {
                        ...
                        if (index == 1) {
                            ...
                            while (true) {
                                ...
                                if (check == "dead") {
                                    ...
                                    int ans = 5;
                                    if (_user2->check(ArmyType::eMankingArmy, RING, ans) == 1)
                                        return 0;
                                } else {
                                    std::cout << "Try again!" << std::endl;
                                    continue;
                ...
                while (true) {
                    ...
                    if (army == "dead") {
                        ...
                        white = _user1->turnWhite(ArmyType::eMankingArmy, roundNo, rn, type);
                    } else {
                        std::cout << "Try again!" << std::endl;
                        continue;
                    }
                        ...
                        if (hl == 1) {
                            ...
                            while (true) {
                                ...
                                if (harmless == "dead") {
                                    ...
                                    rn = _user1->harmless(ArmyType::eMankingArmy, roundNo + 1).first;
                                    type = _user1->eagleHelp(ArmyType::eMankingArmy, roundNo + 1).second;
                                } else {
                                    std::cout << "Try again!" << std::endl;
                                    continue;
                                }
                        ...
                        if (index == 1){
                            ...
                            while (true) {
                                ...
                                if (check == "dead") {
                                    ...
                                    int ans = 5;
                                    if (_user1->check(ArmyType::eMankingArmy, RING, ans) == 1)
                                        return 0;
                                } else {
                                    std::cout << "Try again!" << std::endl;
                                    continue;
...
void Game::_createArmiesForUsers() {
    ...
    white->addArmy(ArmyFactory::createMankingArmy());
